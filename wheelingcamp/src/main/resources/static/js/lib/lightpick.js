...
(function (root, factory) {
  ...
  var document = window.document,
    ...
    renderLeftButton = function (opts) {
      return (
        '<div>' +
    ...
    renderRightButton = function (opts) {
      return (
        '<div>' +
    ...
    weekdayName = function (opts, day, short) {
      return new Date(1970, 0, day).toLocaleString(opts.lang, {
    ...
    Lightpick = function (options) {
      ...
      var html =
        ...
        (opts.numberOfMonths > 1 ? renderRightButton(opts, 'days') : '') +

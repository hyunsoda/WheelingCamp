...
// 인증 번호 확인 버튼을 누를때 인증번호를 검사하는 이벤트
...
authButtonClickEventListener(idAuthBtn, memberName, idAuthNum, idRadios, 1);
...
authButtonClickEventListener(pwAuthBtn, memberId[1], pwAuthNum, pwRadios, 2);

  ...
  if (document.getElementById('myboard-real-btn') != null) {
    document
      ...
      .addEventListener('click', function () {
        ...
        if (previousPage) {
          var targetUrl = 'https://wheelingcamp.store/board/myPosts?cp=' + previousPage;
          window.location = targetUrl;
        } else {
          // 이전 페이지 정보가 없는 경우 기본 페이지로 이동
          window.location = 'https://wheelingcamp.store/board/myPosts?cp=' + 1;
        }
      });
  }
  ...
  if (document.getElementById('mycomment-real-btn') != null) {
    document
      ...
      .addEventListener('click', function () {
        ...
        if (previousPage) {
          var targetUrl =
            'https://wheelingcamp.store/board/myComments?cp=' + previousPage;
          window.location = targetUrl;
        } else {
          // 이전 페이지 정보가 없는 경우 기본 페이지로 이동
          window.location = 'https://wheelingcamp.store/board/myComments?cp=' + 1;
        }
      });
  }

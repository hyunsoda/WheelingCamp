...
INSERT INTO LCS.CAR (ITEM_NO,CAR_GRADE_NO,CAR_PASSENGERS,CAR_SLEEP_CAPACITY,CAR_NAME,CAR_RENT_PRICE,CAR_FUEL) VALUES
(45,2,4,4,'차종45',200000,'GASOLINE');

COMMIT;
--	 (4,1,2,2,'차종4',100000,'GASOLINE'),
--	 (11,3,6,6,'차종11',300000,'GASOLINE'),
--	 (13,2,4,4,'차종13',200000,'GASOLINE'),
--	 (16,4,8,8,'차종16',400000,'GASOLINE'),
--	 (19,3,6,6,'차종19',300000,'GASOLINE'),
--	 (22,2,4,4,'차종22',200000,'GASOLINE'),
--	 (28,2,4,4,'차종28',200000,'GASOLINE'),
--	 (29,2,4,4,'차종29',200000,'GASOLINE'),
--	 (30,4,8,8,'차종30',400000,'GASOLINE'),
--	 (45,2,4,4,'차종45',200000,'GASOLINE');
	;
	
INSERT INTO LCS.CAR (ITEM_NO,CAR_GRADE_NO,CAR_PASSENGERS,CAR_SLEEP_CAPACITY,CAR_NAME,CAR_RENT_PRICE,CAR_FUEL) VALUES
--	 (50,3,6,6,'차종50',300000,'GASOLINE');
--	 (53,1,2,2,'차종53',100000,'GASOLINE');
--	 (56,3,6,6,'차종56',300000,'GASOLINE');
--	 (58,2,4,4,'차종58',200000,'GASOLINE');
--	 (59,4,8,8,'차종59',400000,'GASOLINE');
--	 (60,1,2,2,'차종60',100000,'GASOLINE');
...
ROLLBACK;
 ...
 SELECT IMG_NO, IMG_PATH, IMG_ORIGINAL_NAME, IMG_RENAME, IMG_ORDER, ITEM_NO, IMG_TYPE_NO FROM "ITEM_IMG" WHERE ITEM_NO = 60 ORDER BY IMG_ORDER;
 

ALTER TABLE "CAMP_EQUIPMENT" ADD CONSTRAINT "FK_ITEM_TO_CAMP_EQUIPMENT_1" FOREIGN KEY (
	"ITEM_NO"
)
REFERENCES "ITEM" (
	"ITEM_NO"
...
ALTER TABLE "CAMP_EQUIPMENT" ADD CONSTRAINT "FK_EQUIPMENT_CATEGORY_TO_CAMP_EQUIPMENT_1" FOREIGN KEY (
...
ALTER TABLE "CAR_STOCK" ADD CONSTRAINT "FK_CAR_TO_CAR_STOCK_1" FOREIGN KEY (
	"ITEM_NO"
)
REFERENCES "CAR" (
	"ITEM_NO"
...
ALTER TABLE "CAR_STOCK" ADD CONSTRAINT "FK_CAR_LOCATION_TO_CAR_STOCK_1" FOREIGN KEY (
	"CAR_LOCATION_NO"
)
REFERENCES "CAR_LOCATION" (
	"CAR_LOCATION_NO"
);

ALTER TABLE "CAR" ADD CONSTRAINT "FK_ITEM_TO_CAR_1" FOREIGN KEY (
	"ITEM_NO"
)
REFERENCES "ITEM" (
	"ITEM_NO"
...
ALTER TABLE "CAR" ADD CONSTRAINT "FK_CAR_GRADE_TO_CAR_1" FOREIGN KEY (
	"CAR_GRADE_NO"
)
REFERENCES "CAR_GRADE" (
	"CAR_GRADE_NO"
);

ALTER TABLE "ITEM" ADD CONSTRAINT "FK_ITEM_CATEGORY_TO_ITEM_1" FOREIGN KEY (
	"CATEGORY_CODE"
)
...
ALTER TABLE "RENT" ADD CONSTRAINT "FK_PAY_TO_RENT_1" FOREIGN KEY (
	"PAY_NO"
)
REFERENCES "PAY" (
	"PAY_NO"
...
ALTER TABLE "BOARD" ADD CONSTRAINT "FK_ITEM_TO_BOARD_1" FOREIGN KEY (
	"ITEM_NO"
)
REFERENCES "ITEM" (
	"ITEM_NO"
...
ALTER TABLE "ITEM_IMG" ADD CONSTRAINT "FK_ITEM_TO_ITEM_IMG_1" FOREIGN KEY (
	"ITEM_NO"
)
REFERENCES "ITEM" (
	"ITEM_NO"
...
ALTER TABLE "ITEM_IMG" ADD CONSTRAINT "FK_ITEM_IMG_TYPE_TO_ITEM_IMG_1" FOREIGN KEY (
	"IMG_TYPE_NO"
)
REFERENCES "ITEM_IMG_TYPE" (
	"IMG_TYPE_NO"
);

ALTER TABLE "INTEREST" ADD CONSTRAINT "FK_MEMBER_TO_INTEREST_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"MEMBER_NO"
...
ALTER TABLE "PACKAGE" ADD CONSTRAINT "FK_ITEM_TO_PACKAGE_1" FOREIGN KEY (
	"PACKAGE_NO"
)
REFERENCES "ITEM" (
	"ITEM_NO"
...
ALTER TABLE "PACKAGE_DETAIL" ADD CONSTRAINT "FK_PACKAGE_TO_PACKAGE_DETAIL_1" FOREIGN KEY (
	"PACKAGE_NO"
)
REFERENCES "PACKAGE" (
	"PACKAGE_NO"
...
ALTER TABLE "PACKAGE_DETAIL" ADD CONSTRAINT "FK_ITEM_TO_PACKAGE_DETAIL_1" FOREIGN KEY (
	"ITEM_NO"
)
REFERENCES "ITEM" (
	"ITEM_NO"
...
ALTER TABLE "PACKAGE_DETAIL" ADD CONSTRAINT "FK_CAR_LOCATION_TO_PACKAGE_DETAIL_1" FOREIGN KEY (
	"CAR_LOCATION_NO"
)
REFERENCES "CAR_LOCATION" (
	"CAR_LOCATION_NO"
...
ALTER TABLE "RENT_DETAIL" ADD CONSTRAINT "FK_RENT_TO_RENT_DETAIL_1" FOREIGN KEY (
	"RENT_NO"
)
REFERENCES "RENT" (
	"RENT_NO"
...
ALTER TABLE "RENT_DETAIL" ADD CONSTRAINT "FK_ITEM_TO_RENT_DETAIL_1" FOREIGN KEY (
	"ITEM_NO"
)
REFERENCES "ITEM" (
	"ITEM_NO"
...
CREATE TABLE "DRIVER_LICENSE" (
	DRIVER_LICENSE_NO	NUMBER		NOT NULL,
	MEMBER_NO	NUMBER		NOT NULL,
	LICENSE_NO	NVARCHAR2(20)		NULL,
	DRIVER_LICENSE_DATE	NVARCHAR2(10)		NULL,
	REGISTRATION_DATE	DATE	DEFAULT SYSDATE	NULL
);

COMMENT ON COLUMN "DRIVER_LICENSE"."DRIVER_LICENSE_NO" IS '운전면허증번호(PK)';

COMMENT ON COLUMN "DRIVER_LICENSE"."MEMBER_NO" IS '회원 번호(FK)';

COMMENT ON COLUMN "DRIVER_LICENSE"."LICENSE_NO" IS '운전면허증번호';

COMMENT ON COLUMN "DRIVER_LICENSE"."DRIVER_LICENSE_DATE" IS '윤전면허취득일';

COMMENT ON COLUMN "DRIVER_LICENSE"."REGISTRATION_DATE" IS '운전면허등록일';

ALTER TABLE "DRIVER_LICENSE" ADD CONSTRAINT "PK_DRIVER_LICENSE" PRIMARY KEY (
	"DRIVER_LICENSE_NO"
);

ALTER TABLE "DRIVER_LICENSE" ADD CONSTRAINT "FK_MEMBER_TO_DRIVER_LICENSE_NO" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"MEMBER_NO"
...
CREATE SEQUENCE SEQ_DRIVER_LICENSE_NO;
=======
>>>>>>> development
